  ...
  return (
    <div className=" bg-gray-50">
      ...
      <div className="max-w-7xl mt-14 mb-14 mx-auto bg-white shadow-lg p-4 md:p-10">
        <h2 className="text-2xl font-bold text-[#D4AF37] mb-6">Your Shopping Cart</h2>
          ...
          {cartItems.map((item) => (
            <div key={item._id + item.selectedSize + item.selectedColor} className="flex justify-between items-center">
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  <p className="font-semibold text-[#D4AF37]">{item.productName}</p>
                  <p className="text-sm text-[#D2C385]">Size: {item.selectedSize}</p>
                  <p className="text-sm text-[#D2C385]">Color: {item.selectedColor}</p>
                </div>
              </div>
              ...
              <div className="flex items-center space-x-4">
                <div className="flex items-center space-x-2">
                  <button
                    ...
                    className="px-2 py-1 bg-[#D2C385] text-white rounded"
                  >
                    -
                  </button>
                ...
                <button
                  ...
                  className="text-[#D4AF37] hover:text-[#D2C385]"
                >
                  Remove
                </button>
              </div>
        ...
        <div className="flex justify-between mt-6">
          <p className="text-lg font-semibold text-[#D4AF37]">Total: Tk. {totalPrice.toFixed(2)}</p>
          <button
      className="px-6 py-3 bg-[#D4AF37] text-white rounded-lg hover:bg-[#D2C385] transition"

...
const BestSellers = () => {
  ...
  useEffect(() => {
    ...
    const fetchProducts = async () => {
      try {
        const response = await fetch("https://aarshi.onrender.com/api/products/fetch-products"); // Replace with your API URL
  ...
  return (
    <div>
      ...
      <h2 className="text-3xl font-bold text-center text-[#D4AF37] mt-10 mb-6">
        Best Sellers
      </h2>
  ...
  <div className="text-center text-[#d4af37]">No Best Seller products available.</div>
)}

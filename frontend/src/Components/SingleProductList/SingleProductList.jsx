...
useEffect(() => {
  const fetchReviews = async () => {
    try {
      const response = await fetch(`https://aarshi.onrender.com/api/reviews/${id}`);
...
const handleAddReview = async () => {
  ...
  try {
    const response = await fetch(`https://aarshi.onrender.com/api/reviews/add`, {
      method: "POST",
...
const toggleReviewModal = () => setReviewModalOpen((prev) => !prev);
  ...
  useEffect(() => {
    ...
    const fetchProduct = async () => {
      try {
        const response = await fetch(`https://aarshi.onrender.com/api/products/single/${id}`);
        if (!response.ok) {
